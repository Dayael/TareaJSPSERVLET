...
public class CambiaCliente extends HttpServlet {
    ...
    private void guardaCliente(HttpServletRequest request) 
    {
        ...
        cliente.setNombre(request.getParameter("id"));
        cliente.setApellidoP(request.getParameter("id"));
        cliente.setApellidoM(request.getParameter("id"));
        cliente.setEdad( getCampoInteger( request.getParameter("id") ) );
