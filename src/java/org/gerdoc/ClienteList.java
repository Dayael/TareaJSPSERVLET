        ...
        try (PrintWriter out = response.getWriter()) 
        {
            ...
            if( clientes != null && !clientes.isEmpty() )
            {
                ...
                for( Cliente cliente : clientes )
                {
                    ...
                    out.println( String.format( "<td>%s</td>" , "<a href =\"ClienteList?id=" + j +"&borrar=submit\">Borrar</a>" + "     " + "<a href =\"CambiaCliente?id=" + j +"\">Cambiar</a> " ) );
                    
                    
                    /*
                    <a href =\"CambiaCliente?id=" + j +"&cambiar=submit\">Cambios</a>
                    */
            ...
            out.println("</table>");
            out.println("<a class=\"btn btn-primary\" href=\"AgregaCliente\" role=\"button\">Nuevo Cliente</a>");
